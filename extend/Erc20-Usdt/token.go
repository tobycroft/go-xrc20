...
func (_Token *TokenCaller) SaleEndTime(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
...
//
// Solidity: function saleEndTime() constant returns(uint256)
func (_Token *TokenSession) SaleEndTime() (*big.Int, error) {
	return _Token.Contract.SaleEndTime(&_Token.CallOpts)
}

// SaleEndTime is a free data retrieval call binding the contract method 0xed338ff1.
//
// Solidity: function saleEndTime() constant returns(uint256)
func (_Token *TokenCallerSession) SaleEndTime() (*big.Int, error) {
	return _Token.Contract.SaleEndTime(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) SaleStartTime(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
...
//
// Solidity: function saleStartTime() constant returns(uint256)
func (_Token *TokenSession) SaleStartTime() (*big.Int, error) {
	return _Token.Contract.SaleStartTime(&_Token.CallOpts)
}

// SaleStartTime is a free data retrieval call binding the contract method 0x1cbaee2d.
//
// Solidity: function saleStartTime() constant returns(uint256)
func (_Token *TokenCallerSession) SaleStartTime() (*big.Int, error) {
	return _Token.Contract.SaleStartTime(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) TokenSaleContract(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
...
//
// Solidity: function tokenSaleContract() constant returns(address)
func (_Token *TokenSession) TokenSaleContract() (common.Address, error) {
	return _Token.Contract.TokenSaleContract(&_Token.CallOpts)
}

// TokenSaleContract is a free data retrieval call binding the contract method 0x5d5aa277.
//
// Solidity: function tokenSaleContract() constant returns(address)
func (_Token *TokenCallerSession) TokenSaleContract() (common.Address, error) {
	return _Token.Contract.TokenSaleContract(&_Token.CallOpts)
}
...
func (_Token *TokenTransactor) EmergencyERC20Drain(opts *bind.TransactOpts, token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "emergencyERC20Drain", token, amount)
}

// EmergencyERC20Drain is a paid mutator transaction binding the contract method 0xdb0e16f1.
//
// Solidity: function emergencyERC20Drain(token address, amount uint256) returns()
func (_Token *TokenSession) EmergencyERC20Drain(token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.EmergencyERC20Drain(&_Token.TransactOpts, token, amount)
}

// EmergencyERC20Drain is a paid mutator transaction binding the contract method 0xdb0e16f1.
//
// Solidity: function emergencyERC20Drain(token address, amount uint256) returns()
func (_Token *TokenTransactorSession) EmergencyERC20Drain(token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.EmergencyERC20Drain(&_Token.TransactOpts, token, amount)
}
...
//
// Solidity: event Burn(_burner indexed address, _value uint256)
func (_Token *TokenFilterer) FilterBurn(opts *bind.FilterOpts, _burner []common.Address) (*TokenBurnIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Burn", _burnerRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Burn(_burner indexed address, _value uint256)
func (_Token *TokenFilterer) WatchBurn(opts *bind.WatchOpts, sink chan<- *TokenBurn, _burner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Burn", _burnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
